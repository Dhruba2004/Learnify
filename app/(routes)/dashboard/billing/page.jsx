          ...
          <div className="rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 sm:px-8 lg:p-12 bg-white dark:bg-gray-800">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700 dark:text-gray-300"> Limited Access to AI Tools </span>
              </li>
              <li className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-gray-700 dark:text-gray-300"> Limited Number of Generations </span>
              </li>
              <li className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 sm:px-8 lg:p-12 bg-white dark:bg-gray-800">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700 dark:text-gray-300"> Unlimited Access to AI Tools</span>
              </li>
              <li className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
